...
const sortBy = cmp => {
      ...
      if ($sequedesceascen$b === 1) {
        ...
        if (v.tag === "Cons") {
          if (cmp(a)(v._1).tag === "GT") {
            ...
            $sequedesceascen$a1 = Data$dList$dTypes.$List("Cons", a, as);
            $sequedesceascen$a2 = v._2;
            continue;
          }
          $sequedesceascen$c = false;
          $sequedesceascen$r = Data$dList$dTypes.$List("Cons", Data$dList$dTypes.$List("Cons", a, as), sequences(v));
          continue;
        }
        $sequedesceascen$c = false;
        $sequedesceascen$r = Data$dList$dTypes.$List("Cons", Data$dList$dTypes.$List("Cons", a, as), sequences(v));
      ...
      if ($sequedesceascen$b === 2) {
        ...
        if (v.tag === "Cons") {
          if (
            ...
            $sequedesceascen$b = 2;
            $sequedesceascen$a0 = v._1;
            $sequedesceascen$a1 = ys => as(Data$dList$dTypes.$List("Cons", a, ys));
            $sequedesceascen$a2 = v._2;
            continue;
          }
          $sequedesceascen$c = false;
          $sequedesceascen$r = Data$dList$dTypes.$List("Cons", as(Data$dList$dTypes.$List("Cons", a, Data$dList$dTypes.Nil)), sequences(v));
          continue;
        }
        $sequedesceascen$c = false;
        $sequedesceascen$r = Data$dList$dTypes.$List("Cons", as(Data$dList$dTypes.$List("Cons", a, Data$dList$dTypes.Nil)), sequences(v));
  ...
  const ascending = a => as => v => $sequedesceascen(2, a, as, v);
...
const reverse = /* #__PURE__ */ (() => {
  const go = go$a0$copy => go$a1$copy => {
    ...
    while (go$c) {
      ...
      if (v.tag === "Cons") {
        go$a0 = Data$dList$dTypes.$List("Cons", v._1, acc);
        go$a1 = v._2;
        continue;
      }
      $runtime.fail();
...
const take = /* #__PURE__ */ (() => {
  const go = go$a0$copy => go$a1$copy => go$a2$copy => {
    ...
    while (go$c) {
      ...
      if (v1.tag === "Cons") {
        go$a0 = Data$dList$dTypes.$List("Cons", v1._1, acc);
        go$a1 = v - 1 | 0;
        go$a2 = v1._2;
        continue;
      }
    ...
    while (go$c) {
      ...
      if (v.tag === "Cons") {
        if (v1.tag === "Cons") {
          go$a0 = v._2;
          go$a1 = v1._2;
          go$a2 = Data$dList$dTypes.$List("Cons", f(v._1)(v1._1), acc);
          continue;
        }
        $runtime.fail();
      }
...
const nubBy = p => {
  const go = go$a0$copy => go$a1$copy => go$a2$copy => {
    let go$a0 = go$a0$copy, go$a1 = go$a1$copy, go$a2 = go$a2$copy, go$c = true, go$r;
    while (go$c) {
      const v = go$a0, acc = go$a1, v1 = go$a2;
      if (v1.tag === "Nil") {
        go$c = false;
        go$r = acc;
        continue;
      ...
      if (v1.tag === "Cons") {
        ...
        go$a0 = v2.result;
        go$a1 = Data$dList$dTypes.$List("Cons", v1._1, acc);
        go$a2 = v1._2;
        continue;
      }
      $runtime.fail();
...
const insertBy = v => x => v1 => {
  if (v1.tag === "Nil") { return Data$dList$dTypes.$List("Cons", x, Data$dList$dTypes.Nil); }
  if (v1.tag === "Cons") {
    if (v(x)(v1._1).tag === "GT") { return Data$dList$dTypes.$List("Cons", v1._1, insertBy(v)(x)(v1._2)); }
    return Data$dList$dTypes.$List("Cons", x, v1);
  }
  $runtime.fail();
};
...
const foldM = dictMonad => {
  ...
  return v => b => v1 => {
    if (v1.tag === "Nil") { return pure(b); }
    if (v1.tag === "Cons") { return bind1(v(b)(v1._1))(b$p => foldM(dictMonad)(v)(b$p)(v1._2)); }
    $runtime.fail();
  };
};
const findIndex = fn => {

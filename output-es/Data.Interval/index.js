...
const foldableInterval = {
  foldl: v => z => v1 => {
    if (v1.tag === "StartEnd") { return v(v(z)(v1._1))(v1._2); }
    if (v1.tag === "DurationEnd") { return v(z)(v1._2); }
    if (v1.tag === "StartDuration") { return v(z)(v1._1); }
    return z;
  },
...
const bifoldableInterval = {
  bifoldl: v => v1 => z => v2 => {
    if (v2.tag === "StartEnd") { return v1(v1(z)(v2._1))(v2._2); }
    if (v2.tag === "DurationEnd") { return v1(v(z)(v2._1))(v2._2); }
    if (v2.tag === "StartDuration") { return v1(v(z)(v2._2))(v2._1); }
    if (v2.tag === "DurationOnly") { return v(z)(v2._1); }
    $runtime.fail();
  },

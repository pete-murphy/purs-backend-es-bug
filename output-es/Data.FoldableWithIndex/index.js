...
const foldableWithIndexMaybe = {
  foldrWithIndex: f => {
    ...
    return z => v1 => {
      ...
      if (v1.tag === "Just") { return $1(v1._1)(z); }
      $runtime.fail();
    };
  },
  foldlWithIndex: f => {
    ...
    return z => v1 => {
      if (v1.tag === "Nothing") { return z; }
      if (v1.tag === "Just") { return $1(z)(v1._1); }
      $runtime.fail();
    };
  },
...
const foldableWithIndexEither = {
  foldrWithIndex: v => z => v1 => {
    ...
    if (v1.tag === "Right") { return v(Data$dUnit.unit)(v1._1)(z); }
    $runtime.fail();
  },
  foldlWithIndex: v => z => v1 => {
    if (v1.tag === "Left") { return z; }
    if (v1.tag === "Right") { return v(Data$dUnit.unit)(z)(v1._1); }
    $runtime.fail();
  },

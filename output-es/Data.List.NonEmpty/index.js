...
const snoc$p = v => y => {
  if (v.tag === "Cons") {
    return Data$dNonEmpty.$NonEmpty(v._1, Data$dList$dTypes.foldableList.foldr(Data$dList$dTypes.Cons)(Data$dList$dTypes.$List("Cons", y, Data$dList$dTypes.Nil))(v._2));
  }
  if (v.tag === "Nil") { return Data$dNonEmpty.$NonEmpty(y, Data$dList$dTypes.Nil); }
  $runtime.fail();
};

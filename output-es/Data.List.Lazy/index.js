...
const insertAt = v => x => xs => {
  if (v === 0) { return Data$dLazy.defer(v$1 => Data$dList$dLazy$dTypes.$Step("Cons", x, xs)); }
  return Data$dLazy.defer(v$1 => {
    const $4 = Data$dLazy.force(xs);
    if ($4.tag === "Nil") { return Data$dList$dLazy$dTypes.$Step("Cons", x, Data$dList$dLazy$dTypes.nil); }
    if ($4.tag === "Cons") { return Data$dList$dLazy$dTypes.$Step("Cons", $4._1, insertAt(v - 1 | 0)(x)($4._2)); }
    $runtime.fail();
  });
};
const init = /* #__PURE__ */ (() => {

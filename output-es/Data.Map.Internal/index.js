  ...
  const down = down$a0$copy => down$a1$copy => {
    ...
    while (down$c) {
      ...
      if (v1.tag === "Two") {
        ...
        if (v2.tag === "LT") {
          down$a0 = Data$dList$dTypes.$List("Cons", $TreeContext("TwoLeft", v1._2, v1._3, v1._4), ctx);
          down$a1 = v1._1;
          continue;
        }
        down$a0 = Data$dList$dTypes.$List("Cons", $TreeContext("TwoRight", v1._1, v1._2, v1._3), ctx);
        down$a1 = v1._4;
        continue;
      }
      if (v1.tag === "Three") {
        ...
        if (v3.tag === "LT") {
          down$a0 = Data$dList$dTypes.$List("Cons", $TreeContext("ThreeLeft", v1._2, v1._3, v1._4, v1._5, v1._6, v1._7), ctx);
          down$a1 = v1._1;
          continue;
        }
        if (v3.tag === "GT") {
          if (v4.tag === "LT") {
            down$a0 = Data$dList$dTypes.$List("Cons", $TreeContext("ThreeMiddle", v1._1, v1._2, v1._3, v1._5, v1._6, v1._7), ctx);
            down$a1 = v1._4;
            continue;
          }
          down$a0 = Data$dList$dTypes.$List("Cons", $TreeContext("ThreeRight", v1._1, v1._2, v1._3, v1._4, v1._5, v1._6), ctx);
          down$a1 = v1._7;
          continue;
        }
        down$a0 = Data$dList$dTypes.$List("Cons", $TreeContext("ThreeRight", v1._1, v1._2, v1._3, v1._4, v1._5, v1._6), ctx);
...
const intersectionWith = dictOrd => f => m1 => m2 => {
  const go = go$a0$copy => go$a1$copy => go$a2$copy => {
    ...
    while (go$c) {
      const v = go$a0, v1 = go$a1, m = go$a2;
      if (v.tag === "Nil") {
        go$c = false;
        go$r = m;
        continue;
      ...
      if (v.tag === "Cons") {
        if (v1.tag === "Cons") {
          const v2 = dictOrd.compare(v._1._1)(v1._1._1);
          if (v2.tag === "LT") {
            go$a0 = v._2;
            go$a1 = v1;
            go$a2 = m;
          ...
          if (v2.tag === "EQ") {
            go$a0 = v._2;
            go$a1 = v1._2;
            go$a2 = insert(dictOrd)(v._1._1)(f(v._1._2)(v1._1._2))(m);
            continue;
          }
          if (v2.tag === "GT") {
            go$a0 = v;

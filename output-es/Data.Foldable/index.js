...
const intercalate = dictFoldable => dictMonoid => {
  ...
  return sep => xs => dictFoldable.foldl(v => x => {
    if (v.init) { return {init: false, acc: x}; }
...
const foldableMaybe = {
  foldr: v => z => v1 => {
    if (v1.tag === "Nothing") { return z; }
    if (v1.tag === "Just") { return v(v1._1)(z); }
    $runtime.fail();
  },
  foldl: v => z => v1 => {
    if (v1.tag === "Nothing") { return z; }
    if (v1.tag === "Just") { return v(z)(v1._1); }
    $runtime.fail();
  },
...
const foldableEither = {
  foldr: v => z => v1 => {
    if (v1.tag === "Left") { return z; }
    if (v1.tag === "Right") { return v(v1._1)(z); }
    $runtime.fail();
  },
  foldl: v => z => v1 => {
    if (v1.tag === "Left") { return z; }
    if (v1.tag === "Right") { return v(z)(v1._1); }
    $runtime.fail();
  },
  foldMap: dictMonoid => v => v1 => {
